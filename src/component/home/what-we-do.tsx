...
export const WhatWeDo = () => {
  return (
    <Section>
      <Grid container spacing={{xs:0,md:8}} textAlign={{xs:'center',md:'left'}}>
        <Grid item xs={12} md={6}>
          <Box sx={{ position: "relative"}}>
            <Box component={Image} src={whatwedo} alt="" width={{xs:300,md:'auto'}} height={{xs:300,md:'auto'}} />
          </Box>
        </Grid>
        <Grid item xs={12} md={6}>
          <Heading
          ...
          <Stack direction={{xs:'column',md:'row'}} spacing={4} mt={3} textAlign={'left'} sx={{width:{xs:'90%',md:'100%'},mx:'auto'}}>
            <Stack spacing={3}>
